        ...
        <div className="container mx-auto px-4">
          ...
          <section className="mb-16">
            <div className="text-center mb-8">
              <h2 className="text-2xl font-bold text-[#1B3C53] mb-2">
                Example 1: Full-width Media Grid
              </h2>
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
              ...
              <div className="lg:col-span-1">
                <div className="bg-white p-6 rounded-lg shadow-md border border-[#D2C1B6]">
                  <h3 className="text-lg font-semibold text-[#1B3C53] mb-4">Sidebar Content</h3>
                  <p className="text-gray-600 mb-4">
                    This shows how the MediaGrid can be integrated into different layouts.
                  </p>
                  <div className="space-y-2">
                    <div className="p-3 bg-[#F9F3EF] rounded border border-[#D2C1B6]">
                      Navigation Item 1
                    </div>
                    <div className="p-3 bg-[#F9F3EF] rounded border border-[#D2C1B6]">
                      Navigation Item 2
          ...
          <section className="mb-16">
            ...
            <div className="max-w-6xl mx-auto">
              <div className="bg-white rounded-lg shadow-lg border border-[#D2C1B6] overflow-hidden">
                <div className="bg-[#1B3C53] text-white p-6">
                  <h3 className="text-xl font-semibold">Featured Content</h3>
                  <p className="text-[#D2C1B6]">Showcase your media in a beautiful card</p>
                </div>
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md border border-[#D2C1B6]">
                <h3 className="text-lg font-semibold text-[#1B3C53] mb-4">Grid 1</h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md border border-[#D2C1B6]">
                <h3 className="text-lg font-semibold text-[#1B3C53] mb-4">Grid 2</h3>
                <div className="h-[40vh]">
                  <MediaGrid slug="home-hero" />
                </div>
              </div>
          ...
          {/* Usage Instructions */}
          <section className="bg-white p-8 rounded-lg shadow-md border border-[#D2C1B6]">
            <h2 className="text-2xl font-bold text-[#1B3C53] mb-6">How to Use MediaGrid Component</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-lg font-semibold text-[#1B3C53] mb-3">Basic Usage</h3>
...
<MediaGrid slug="your-layout-slug" />`}
              ...
              <div>
                <h3 className="text-lg font-semibold text-[#1B3C53] mb-3">With Custom Styling</h3>
                <div className="bg-gray-100 p-4 rounded font-mono text-sm">
  ...
  <MediaGrid slug="home-hero" />
            ...
            <div className="mt-6">
              <h3 className="text-lg font-semibold text-[#1B3C53] mb-3">Available Layouts</h3>
