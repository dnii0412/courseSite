                      ...
                      {cell.mediaId && cell.media ? (
                        <div className="w-full h-full relative group bg-yellow-100">
                          <img 
                            ...
                            onLoad={(event) => {
                              console.log('Image loaded successfully:', {
                                mediaId: cell.mediaId,
                                url: cell.media?.cloudinarySecureUrl,
                                naturalWidth: (event.target as HTMLImageElement).naturalWidth,
                                naturalHeight: (event.target as HTMLImageElement).naturalHeight,
                                offsetWidth: (event.target as HTMLImageElement).offsetWidth,
                                offsetHeight: (event.target as HTMLImageElement).offsetHeight
                              })
                            }}
                            onError={(e) => {
                            ...
                            onAbort={() => {
                              console.log('Image load aborted:', cell.mediaId)
                            }}
                          />
                          ...
                          <div 
                            ...
                            onClick={(e) => {
                              e.stopPropagation()
                              console.log('Click to edit overlay clicked for cell:', cell)
                              handleEditCell(cell)
                            }}
                          >
